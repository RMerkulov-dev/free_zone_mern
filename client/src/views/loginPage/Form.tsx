...
const Form = () => {
  ...
  const register = async (values: RegisterValues, onSubmitProps: FormikHelpers<RegisterValues>) => {
  ...
  const login = async (values: RegisterValues, onSubmitProps: FormikHelpers<RegisterValues>) => {
    try {
      setLoading(true);
  ...
  const handleFormSubmit = async (values: RegisterValues, onSubmitProps: any) => {
              ...
              <>
                ...
                >
                  <Dropzone
                    ...
                    multiple={false}
                    onDrop={(acceptedFiles: File[]) => setFieldValue('picture', acceptedFiles[0])}
                  >
